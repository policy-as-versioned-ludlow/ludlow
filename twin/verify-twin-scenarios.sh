#!/usr/bin/env bash
# Beat: "ludlow's twin carries six standing scenarios of its own, four of them realising committed
...
cat "$log"
case $rc in
  0) echo "PASS: ludlow carries its six standing scenarios, four committed classes in all three places, and no fine amount in the twin";;
