...
what this repository's Flux Kustomization reconciles at `path: ./apps`), it is graded by ludlow's
...
diff` it against `policy-as-versioned-flux/reports` at that commit and see the whole of the move.
